...
public abstract class AbstractStaxParser<T, E> implements StaxParser {
     ...
     * <b>Precondition:</b> Current event is the {@link StartElement} of the subelement being processed<br>
     * <b>Postcondition:</b> Current event is either the same {@link StartElement} or the corresponding {@link EndElement}.
     * @param xmlEventReader

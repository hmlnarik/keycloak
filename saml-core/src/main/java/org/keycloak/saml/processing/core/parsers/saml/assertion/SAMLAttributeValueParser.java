...
public class SAMLAttributeValueParser implements StaxParser {
    ...
    private static final QName XSI_TYPE = new QName(JBossSAMLURIConstants.XSI_NSURI.get(), JBossSAMLConstants.TYPE.get(), JBossSAMLURIConstants.XSI_PREFIX.get());
    ...
    public Object parse(XMLEventReader xmlEventReader) throws ParsingException {
        ...
        StaxParserUtil.validate(element, JBossSAMLConstants.ATTRIBUTE_VALUE.getAsQName());
        ...
        if (type == null) {
            ...
            if (xmlEvent instanceof StartElement) {
                ...
                String tag = StaxParserUtil.getElementName(element);

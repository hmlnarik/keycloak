...
/**
 * Variants of updating {@link SessionIdMapper} entries.
 * @author hmlnarik
 */
public enum SessionIdMapperUpdater {
    /**
     * {@link SessionIdMapper} entries are updated directly by the session store together with HTTP session
     */
    DIRECT {
    ...
    /**
     * Only HTTP session is manipulated with, {@link SessionIdMapper} entries are updated externally by some listener of HTTP session changes.
     */
    EXTERNAL {
        @Override public void clear(SessionIdMapper idMapper) { }

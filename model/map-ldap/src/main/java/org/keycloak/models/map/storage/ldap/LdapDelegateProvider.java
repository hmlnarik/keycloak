...
/**
 * Base class for all delegate providers for the LDAP storage.
 *
 * Wraps the delegate so that it can be safely updated during lazy loading.
 */
public abstract class LdapDelegateProvider<T extends AbstractEntity> {
    private T delegate;

    protected LdapDelegateProvider(T delegate) {
    ...
    protected void setDelegate(T newDelegate) {
        ...
        // TODO: find out if entity has been modified in LDAP (maybe last modified date?)

...
public class ConcurrentHashMapStorageProvider implements MapStorageProvider {
    ...
    private static <K, V extends HasUpdated<K>> ConcurrentHashMapStorage<?, V> loadMap(String fileName, Class<V> valueType, EnumSet<Flag> flags) {
    ...
    public <K, V extends HasUpdated<K>> MapStorage<K, V> getStorage(String name, Class<K> keyType, Class<V> valueType, Flag... flags) {

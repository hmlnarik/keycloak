...
public class IdpCreateUserIfUniqueAuthenticator extends AbstractIdpAuthenticator {
    ...
    protected void authenticateImpl(AuthenticationFlowContext context, SerializedBrokeredIdentityContext serializedCtx, BrokeredIdentityContext brokerContext) {
        ...
        if (context.getAuthenticationSession().getNote(EXISTING_USER_INFO) != null) {
            context.attempted();
            return;
        }
        ...
        if (duplication == null) {
            ...
            context.getAuthenticationSession().setNote(BROKER_REGISTERED_NEW_USER, "true");
            context.success();
        } else {
            ...
            context.getAuthenticationSession().setNote(EXISTING_USER_INFO, duplication.serialize());

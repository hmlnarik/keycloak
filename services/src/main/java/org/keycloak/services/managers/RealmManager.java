...
public class RealmManager {
    ...
    protected void setupAdminConsoleLocaleMapper(RealmModel realm) {
        ClientModel adminConsole = session.clientStorageManager().getClientByClientId(Constants.ADMIN_CONSOLE_CLIENT_ID, realm);
    ...
    public boolean removeRealm(RealmModel realm) {
        ...
        if (removed) {
            if (masterAdminClient != null) {
                session.realms().removeClient(masterAdminClient.getId(), getKeycloakAdminstrationRealm());
            }
